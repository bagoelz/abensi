...
@Component({
  selector: 'potongan',
  templateUrl: './potongan.component.html',
  styleUrls: ['./potongan.component.scss'],
  animations: fuseAnimations,
  encapsulation: ViewEncapsulation.None
})
export class PotonganComponent implements OnInit {
  dataSource: MatTableDataSource<any>;
  displayedColumns = ['tm', 'wt', 'pp'];
  /**
    * Constructor
    *
  ...
  getPotongan() {
    this.API.getPotongan().subscribe(result => {
